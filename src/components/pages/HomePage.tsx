    ...
    <Box sx={{ minHeight: "100vh", bgcolor: "#ffffff", color: "text.primary" }}>
      ...
      <Section id="cases" tone="muted">
        <SectionHeader
          ...
          subtitle="Два примера ниже; остальные кейсы — на странице «Кейсы». Производство, строительство, IT и e‑commerce: задача, что сделали, результат. Без выдуманных процентов роста."
        />
        <CasesGrid limit={2} />
        <Box sx={{ mt: 2.5 }}>
