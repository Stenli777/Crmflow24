    ...
    >
      <Stack spacing={2} sx={{ mt: 2, maxWidth: 900 }}>
        ...
        <P>
          ...
          Срок хранения — не дольше, чем нужно для этих целей, если иное не требует закон или договор с вами.
        </P>
        ...
        <P>
          ...
          связи, CRM «Битрикс24») — на основании договоров и с соблюдением требований 152-ФЗ. По запросу:{" "}
          <MuiLink href={`mailto:${legalConfig.privacyEmail}`}>{legalConfig.privacyEmail}</MuiLink>.
        </P>
