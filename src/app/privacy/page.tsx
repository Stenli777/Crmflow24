...
export const metadata: Metadata = {
  ...
  description:
    "Политика ООО «Лиса Эдженси» в отношении обработки персональных данных посетителей сайта и заявок.",
      ...
      <Section>
        ...
        <Stack spacing={2} sx={{ mt: 2, maxWidth: 900 }}>
          <P>
            ...
            <MuiLink href={site}>{siteConfig.siteDomain}</MuiLink> (далее — «Сайт»), в том числе через
          ...
          <P>
            ...
            технические данные (например, IP-адрес, тип браузера, дата и время запроса) в объёме,
            необходимом для работы Сайта и безопасности, а также с учётом настроек по файлам cookie (
          ...
          <P>
            ...
            <strong>не осуществляется</strong>. Если такой канал будет введён, мы запросим отдельное
            согласие и обновим Политику.
          </P>

          <H3>4. Правовые основания</H3>
          <P>
            Согласие субъекта персональных данных; исполнение договора, стороной которого является субъект
            (при его заключении); неотъемлемые права оператора в связи с вашим обращением; обязанности,
          ...
          <P>
            ...
            персональных данных в целях рассмотрения обращения и связи. Текст согласия у формы приведён к
            Политике; при отказе от отправки обработка данных для этой цели не производится.
          </P>

          <H3>6. Действия с данными и сроки</H3>
          <P>
            Мы осуществляем сбор, запись, систематизацию, накопление, хранение, уточнение, использование,
            обезличивание, блокирование, удаление и уничтожение — в объёме, необходимом для целей из раздела
            3. Срок хранения — не дольше, чем нужно для этих целей, если иное не требует закон или договор с
            вами.
          </P>
          ...
          <P>
            ...
            также привлечённым для работы Сайта и обработки заявок подрядчикам (например, хостинг, сервисы
            связи, CRM «Битрикс24») — на основании договоров и с соблюдением требований 152-ФЗ. Актуальный
            перечень категорий получателей может уточняться; по запросу направьте обращение на{" "}
          ...
          <P>
            ...
            Роскомнадзоре или в суде, а также реализовать иные права, предусмотренные 152-ФЗ. Обращения — на{" "}
            <MuiLink href={`mailto:${legalConfig.privacyEmail}`}>{legalConfig.privacyEmail}</MuiLink>.
          </P>
          ...
          <Typography variant="body2" color="text.secondary" sx={{ mt: 3, pt: 2, borderTop: 1, borderColor: "divider" }}>
            ...
            сайта: {siteConfig.brandName}. Проект реализуется {legalConfig.operatorName}.
          </Typography>
        </Stack>
      </Section>
      <Footer />
