  ...
  return (
    <Box sx={{ minHeight: "100vh", bgcolor: "#ffffff", color: "text.primary" }}>
          ...
          >
            <Stack spacing={{ xs: 2.5, md: 3 }} sx={{ minWidth: 0 }}>
              ...
              <Box sx={{ display: "flex", flexWrap: "wrap", gap: 1.25 }}>
                <Button href="/contacts" variant="contained" size="large" sx={{ px: 2.5, fontWeight: 700 }}>
                  Разобрать вашу CRM
                </Button>
                <Button
                  component={Link}
      ...
      <Section id="cta" tone="muted">
        <CtaBanner
          title="Разберём вашу CRM и предложим план наведения порядка"
          text="На встрече уточним процесс, источники заявок и отчётность. Покажем, где обычно теряется управляемость, и предложим этапы внедрения без лишней нагрузки на команду."
        />
        <Box sx={{ mt: 2, display: "flex", gap: 1.25, flexWrap: "wrap" }}>
          <Button component={Link} href="/contacts" variant="outlined" sx={{ fontWeight: 700 }}>
